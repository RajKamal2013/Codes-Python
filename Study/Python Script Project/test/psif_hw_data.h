...
}; /* enum psif_modify_status [ 3 bits] */
...
}; /* enum psif_event_status [ 8 bits] */

/* What type of event is this. *//* Extent 4 bit */
enum psif_event_type {
...
enum psif_port_samplecounter_type {
...
}; /* enum psif_port_samplecounter_type [ 7 bits] */
 ...
 *//* Extent 3 bit */
enum psif_header_split_control {
	HDR_SPLIT_NONE,
	HDR_SPLIT_ENCAP	 = 0x4,
	HDR_SPLIT_L2,
	HDR_SPLIT_L3,
	HDR_SPLIT_L4
}; /* enum psif_header_split_control [ 3 bits] */

/* Extent 2 bit */
enum psif_trace_sample_source {
	RCV0	 = 0,
	RCV1	 = 0x1,
	XMIT0	 = 0x2,
	XMIT1	 = 0x3
}; /* enum psif_trace_sample_source [ 2 bits] */

/* Extent 2 bit */
enum psif_trace_buffer_allocation {
	POST_STORE_0	 = 0,
	POST_STORE_25	 = 0x1,
	POST_STORE_50	 = 0x2,
	POST_STORE_75	 = 0x3
}; /* enum psif_trace_buffer_allocation [ 2 bits] */

/* Extent 1 bit */
enum psif_trace_buffer_mode {
	NORMAL_MODE	 = 0,
	TRACE_MODE	 = 0x1
}; /* enum psif_trace_buffer_mode [ 1 bits] */

/* Extent 2 bit */
enum psif_trace_buffer_status {
	TRACE_IDLE	 = 0,
	WAIT_TRIGGER	 = 0x1,
	POST_STORE	 = 0x2,
	TRACE_DONE	 = 0x3
}; /* enum psif_trace_buffer_status [ 2 bits] */
 ...
 *//* Extent 32 bit */
enum psif_epsc_csr_trace_control {
...
}; /* enum psif_epsc_csr_trace_control [32 bits] */

/*
 *//* Extent 3 bit */
enum psif_ib_link_speed {
...
}; /* enum psif_ib_link_speed [ 3 bits] */

/*
 *//* Extent 2 bit */
enum psif_ib_link_width {
	PSIF_LINK_WIDTH_X4	 = 0,
	PSIF_LINK_WIDTH_X1	 = 0x1,
	/* Padding out to required bits allocated */
	PSIF_IB_LINK_WIDTH_FIELD_MAX	 = 0x3
}; /* enum psif_ib_link_width [ 2 bits] */
